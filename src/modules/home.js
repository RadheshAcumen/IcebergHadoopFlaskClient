...
//     return (
//         <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white py-5 px-4">
//             <div className="container mx-auto flex flex-col items-center">
//                 {/* Selection Card */}
//                 <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col md:flex-row items-center md:space-x-6 space-y-4 md:space-y-0 w-full">
//                     {/* Source Format */}
...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white py-5 px-4">
            <div className="container mx-auto flex flex-col items-center">
                {/* Selection Card */}
                <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col md:flex-row md:space-x-6 w-full space-y-4 md:space-y-0">
                    {/* Source Format */}
